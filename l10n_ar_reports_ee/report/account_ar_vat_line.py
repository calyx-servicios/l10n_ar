...
class AccountArVatLine(models.Model):
    ...
    itc_tax = fields.Monetary(readonly=True, string=_('ITC tax'), currency_field='company_currency_id')
...
SELECT
    ...
    sum(CASE WHEN ntg.l10n_ar_vat_afip_code is null and ntg.l10n_ar_tribute_afip_code != '06' THEN aml.balance ELSE Null END) as other_taxes,
        sum(CASE WHEN ntg.l10n_ar_vat_afip_code is null AND ntg.l10n_ar_tribute_afip_code != '06' AND nt.description = 'ICL' THEN aml.balance ELSE Null END) as icl_tax,
    sum(CASE WHEN ntg.l10n_ar_vat_afip_code is null AND ntg.l10n_ar_tribute_afip_code != '06' AND nt.description = 'ITC' THEN aml.balance ELSE Null END) as itc_tax,
    sum(CASE WHEN ntg.l10n_ar_vat_afip_code is null AND ntg.l10n_ar_tribute_afip_code != '06' AND nt.description = 'IDC' THEN aml.balance ELSE Null END) as idc_tax,
